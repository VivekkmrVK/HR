...
<body>
<h1>EDIT EMPLOYEE'S SALARY DETAILS</h1>
...
<td>Basic Salary :</td>
<td><input type="text" name=username placeholder="Enter basic salary"></td>

</tr>

<tr>
<td>Salary per Day : </td>
<td><input type="text" name=username placeholder="Enter salary per day"><br></td>
